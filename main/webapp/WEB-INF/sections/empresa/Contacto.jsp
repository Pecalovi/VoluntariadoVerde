...
<% if(request.getAttribute("mensajeStatus") != null) { %>
    <p style="color: blue; font-weight: bold;"><%= request.getAttribute("mensajeStatus") %></p>
<% } %>
	...
	<div id="contacto_info">
		...
		<p>+34 123 45 67 89</p>
		<a href="mailto:voluntariadoverdev@gmail.com">voluntariadoverdev@gmail.com</a>
	</div>
</div>
...
<form id="contactForm" action="contacto" method="post">
    ...
    <textarea class="inputcont" name="Text1" rows="4" 
              placeholder="<%=lang.equals("en") ? "Write your message..." : "Escribe tu mensaje..."%>" required></textarea>

    <input type="submit" class="botones" value="<%=lang.equals("en") ? "Send" : "Enviar"%>">
</form>
