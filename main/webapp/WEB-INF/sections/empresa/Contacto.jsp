...
%>
<div id="info">
	<h1 id="contactanosh1"><%=lang.equals("en") ? "Contact us" : "Contáctanos"%></h1>
	...
	<img alt="" src="src/ubiblanco.png">
		<a
			...
			target="_blank">
			<p><%=lang.equals("en") ? "Licenciado Poza Street 31, 48011 Bilbao, Biscay"
		: "Licenciado Poza Kalea 31, 48011 Bilbao, Vizcaya"%>
			</p> </a>
			</div>
		<div class="icono_texto"> 
		<img alt="" src="src/movilblanco.png">
		<p>+34 123 45 67 89</p></div>
		<div class="icono_texto"> 
		<img alt="" src="src/emailblanco.png">
		<a href="mailto:correoelectronico@gmail.com">voluntariadoverdev@gmail.com</a></div>
	</div>
</div>
