...
<div class="tarjeta-perfil">
	<div class="menu-perfil">
		...
		<div class="info-sostenibilidad-wrapper">
			<button class="btn-info-sostenibilidad" data-bs-toggle="modal" data-bs-target="#modalSostenibilidad" title="Documentos de sostenibilidad">i</button>
		</div>
	</div>
		...
		<div class="modal-dialog" style="margin-top: 5rem;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p><%=lang.equals("es") ? "Consulta nuestros documentos de sostenibilidad:" : "Check out our sustainability documents:"%></p>
					<ul class="lista-docs">
						<li><a href="<%=request.getContextPath()%>/sostenibilidad?doc=guia" target="_blank"><%=lang.equals("es") ? "Guía de Sostenibilidad" : "Sustainability Guide"%></a></li>
						<li><a href="<%=request.getContextPath()%>/sostenibilidad?doc=prl" target="_blank"><%=lang.equals("es") ? "Prevención de Riesgos Laborales (PRL)" : "Occupational Risk Prevention (PRL)"%></a></li>
					</ul>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><%=lang.equals("es") ? "Cerrar" : "Close"%></button>
				</div>
			</div>
		</div>
	</div>
