<div id="info">
      ...
      <div id="contacto_descripcion">
        <p>Si necesitas más información o tienes alguna duda, estaremos encantados de atenderte.</p>
        <p>Rellena este formulario para poder ponernos en contacto contigo.</p>
      </div>
    ...
    <form>
      ...
      <input type="text" id="fname" class="inputcont" name="funame" placeholder="Nombre">
      <input type="text" id="femail" class="inputcont" name="femail" placeholder="Correo">
      <input type="text" id="fasunto" class="inputcont" name="fasunto" placeholder="Asunto">

      <textarea id="fmsg" class="inputcont" name="Text1" rows="1" placeholder="Escribe tu mensaje..."></textarea>
