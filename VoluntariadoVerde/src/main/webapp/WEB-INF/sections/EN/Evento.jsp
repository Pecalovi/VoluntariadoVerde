<div id="tarjeta">
	...
	<div id="tarjeta-info">
		...
		<div id="resumen">
			...
			<div class="icoytxt">
				<img class="icono" src="src/Icono-evento_ubi.png" alt="location icon">
		...
		<div id="inscripcion">
			<p>${evento.inscritos}/${evento.plazasTotales} registered</p>
			<form action="${pageContext.request.contextPath}/ServInscripcion"
				...
				if (inscrito) {
				%>
				<input type="button" class="botones" value="You are already registered!" disabled
					style="background-color: #ccc; color: #666; border: 1px solid #999; cursor: not-allowed; margin-top: 0;">

				<%
				} else {
				%>
				<input type="submit" class="botones" value="Sign up"
					style="margin-top: 0;">
				<%
				}
				%>
